...
export class CommandeService {
  ...
  async createCommande(clientId: ClientId, creationDate: CommandeCreationDate): Promise<Commande> {
    ...
    await this.redisCommandeService.setStatus(commande.id, commande.status);
